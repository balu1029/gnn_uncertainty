...
class MVE(BaseUncertainty):
    ...
    def fit(self, epochs, train_loader, valid_loader, device, dtype, model_path="gnn/models/mve.pt", use_wandb=False, warmup_steps=0, force_weight=1.0, energy_weight=1.0, log_interval=100, patience=200, factor=0.1, lr=1e-3, min_lr=1e-6, additional_logs=None): 
