...
valid_uniform = "al/base_data/test"
validationset = MD17Dataset(
    validset_in, subtract_self_energies=False, in_unit="kj/mol", train=False
)
trainset = MD17Dataset(
    validset_in, subtract_self_energies=False, in_unit="kj/mol", train=True
)
...
testset_uniform = MD17Dataset(
    valid_uniform, subtract_self_energies=False, in_unit="kj/mol"
)
