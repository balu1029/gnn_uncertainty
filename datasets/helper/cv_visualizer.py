...
def animate_active_learning(base_path, paths, fps=15):
    ...
    def update(frame):
        ...
        # Add legend
        red_patch = plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='red', markersize=5, label='Training', linestyle='None')
        blue_patch = plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='blue', markersize=5, label='Sampled', linestyle='None')
