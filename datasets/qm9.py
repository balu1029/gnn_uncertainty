...
from datasets.helper.qm9_collate import collate_fn
from datasets.helper.qm9_utils import initialize_datasets
from torch.utils.data import DataLoader
from datasets.helper.qm9_utils import initialize_datasets
from datasets.helper.qm9_args import init_argparse
from datasets.helper.qm9_collate import collate_fn
...
class QM9():
    ...
    def create(self, batch_size, num_workers):
        self.dataloaders, self.charge_scale = retrieve_dataloaders(batch_size, num_workers)
